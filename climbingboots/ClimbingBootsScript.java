...
@ScriptManifest(author = "skengrat", name = "Climbing Boots", version = 1.2, description = "Buys climbing boots from tenzing and banks them at castle wars bank, or trade with given acc", category = Category.MONEYMAKING)
